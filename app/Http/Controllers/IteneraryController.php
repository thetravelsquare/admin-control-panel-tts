...
use App\Imports\IteneraryImport;
...
class IteneraryController extends Controller
{
    public function index(){
        ...
        // dd($iteneraries);
        return view('itenerary.iteneraries', compact('iteneraries'));
    ...
    public function create(){
        $cities = City::all();
        return view('itenerary.itenerary-form', compact('cities'));
    }
    ...
    public function store(Request $request){
        ...
        if($itenerary->save()){
            return back()->with('success', 'Itenerary Added Successfully');
        }
    }
    ...
    public function iteneraryDetails($id){
        $itenerary = Itenerary::findOrFail($id);
        $cities = City::all();
        return view('itenerary.itenerary-details', compact('itenerary', 'cities'));
    }
    
    public function fileImportExport()
    {
       return view('itenerary.file-import');
    }

    public function fileImport(Request $request){
        Excel::import(new IteneraryImport, $request->file('file')->store('temp'));
        return back()->with('success', 'Itenerary Upload Successfully');
    }
}

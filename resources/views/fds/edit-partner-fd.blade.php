...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit FD</h1>
    </div>
    <div class="text-right"><a href="{{ route('partner-fds') }}" class="btn btn-dark">Go Back</a></div>
    <hr>
    ...
    <div class="row">
        <div class="col-lg-12 col-xl-12 ">
            <div class="kt-portlet">
                ...
                @endif
                <!--begin::Form-->
                <form action="{{ route('update-partner-fd', $fds->id) }}" class="kt-form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                @csrf
                    ...
                    <p></p>
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input class="form-control" type="text" name="airline" value="{{ $fds->airline }}" id='example-number-input'>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input class="form-control" type="text"  name="flight_no" value="{{ $fds->flight_no }}" id="example-number-input">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input class="form-control" type="text" name="departure_from" value="{{ $fds->departure_from }}" id="example-number-input">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input class="form-control" type="text" name="arrival_to" value="{{ $fds->arrival_to }}" id="example-number-input">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input class="form-control" type="time" name="departure_time" value="{{ $fds->departure_time }}" id="example-number-input">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input class="form-control" type="time" name="arrival_time" value="{{ $fds->arrival_time }}" id="example-number-input">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input class="form-control" type="date" name="departure_date" value="{{ $fds->departure_date }}" id="example-number-input">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input class="form-control" type="date" name="arrival_date" value="{{ $fds->arrival_date }}" id="example-number-input">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input class="form-control" type="text" name="journey_type" value="{{ $fds->journey_type }}" id="example-number-input">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input class="form-control" type="text" name="flight_type" value="{{ $fds->flight_type }}" id="example-number-input">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                ...
                                <textarea name="baggage_policy" id="" cols="30" rows="5">{{ $fds->baggage_policy }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input class="form-control" type="text" name="fd_id" value="{{ $fds->fd_id }}" id="example-number-input">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input class="form-control" type="text" name="sector" value="{{ $fds->sector }}" id="example-number-input">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="international_or_domestic" class="custom-select form-control" required>
                                    ...
                                    <option @if($fds->international_or_domestic == 'International') selected @endif value="International">International</option>
                                    <option @if($fds->international_or_domestic == 'Domestic') selected @endif value="Domestic">Domestic</option>
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input class="form-control" type="text" name="adult_fare" value="{{ $fds->adult_fare }}" id="example-number-input">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input class="form-control" type="text" name="child_fare" value="{{ $fds->child_fare }}" id="example-number-input">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input class="form-control" type="text" name="service_fee" value="{{ $fds->service_fee }}" id="example-number-input">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input class="form-control" type="text" name="fare_type" value="{{ $fds->fare_type }}" id="example-number-input">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input class="form-control" type="text" name="rescheduling_fee" value="{{ $fds->rescheduling_fee }}" id="example-number-input">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input class="form-control" type="text" name="cancellation_fee" value="{{ $fds->cancellation_fee }}" id="example-number-input">
                    ...
                    <div class="kt-portlet__foot">
                        <div class="kt-form__actions">
                            <button type="submit" class="btn btn-dark">Update Fixed Departure</button>

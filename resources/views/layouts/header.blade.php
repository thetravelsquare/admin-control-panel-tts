...
<head>
    ...
    <link rel="stylesheet" href="http://staging.owowaas.com/assets/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" href="http://staging.owowaas.com/assets/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
</head>
<body id="page-top">
    <div id="wrapper">
            ...
            <li class="nav-item">
                ...
                <div id="datamanagement" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('partner-fds') }}">Partner Fixed Departures</a>
                        <a class="collapse-item" href="utilities-animation.html">Flights</a>
                        <a class="collapse-item" href="utilities-other.html">Hotels</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('bookings') }}">TTS OTA</a>
            ...
            <li class="nav-item">
                ...
                <div id="requests" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('partner-group-fare-requests') }}">Partner Group FD</a>
                    </div>
                </div>
            </li>
            <hr class="sidebar-divider">
